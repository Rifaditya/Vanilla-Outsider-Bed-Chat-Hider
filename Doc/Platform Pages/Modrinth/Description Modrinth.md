...
<!-- Banner Placeholder -->
<!-- ![Vanilla Outsider: Bed Chat Hider Banner](https://files.catbox.moe/example.png) -->
...
## 🔧 Configuration
This mod is plug-and-play with **zero config files or GameRules**. The toggle state is stored purely in-memory during your current session.

---

## ☕ Support the Development

If you enjoy the **Vanilla Outsider** collection, consider supporting the development!
