...
<blockquote>
    <strong>Collection Notice:</strong> Unlike other mods in the Vanilla Outsider Collection (such as <em>True Sleep</em>), Bed Chat Hider is 100% client-only and requires zero configuration files or GameRules.
